...
for %%i in (java.exe) do set "JAVA_HOME_TEMP=%%~$PATH:i"
if not "%JAVA_HOME_TEMP%" == "" (
    set "JAVA_HOME=%JAVA_HOME_TEMP:~0,-13%"
    goto OkJHome
)
...
IF NOT EXIST "%MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.properties" (
    echo.
    echo Exception: No .mvn\wrapper\maven-wrapper.properties found in %MAVEN_PROJECTBASEDIR% >&2
    echo.
    goto error
)

@REM End of all documentation found at
@REM https://github.com/takari/maven-wrapper/blob/master/mvnw.cmd
